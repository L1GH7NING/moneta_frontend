...
const ExpensesPieChart = ({ data, loading }) => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-full bg-white rounded-lg shadow-lg p-6">
  ...
  return (
    <div className="flex flex-col items-center w-full h-full justify-between bg-white rounded-lg shadow-lg p-6">
